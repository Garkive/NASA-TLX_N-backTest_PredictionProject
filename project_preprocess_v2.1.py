...
def create_preprocessed_raw_data(output_filename, choose_type):
...
def main():
	...
	#Choose data you want, normal output(=1) or encoded output(=0)
	#Normal output for Chained NNs, encoded output for normal NN
    
	choose_type = 0
    
	if choose_type == 0:
		output_filename = "preprocessed_raw_data.csv"
		create_preprocessed_raw_data(output_filename, choose_type)
	elif choose_type == 1:
		output_filename = "preprocessed_original_data.csv"
		create_preprocessed_raw_data(output_filename, choose_type)
